...
from .preprocessing.textcleaner import clean_sentence_list as _clean_sentence_list
...
def summarize(sentence_list, ratio=0.2, words=None, language="english", split=False, scores=False):
    if not isinstance(sentence_list, list):
        raise ValueError("Sentence list parameter must be a list!")

    # Gets a list of processed sentences.
    sentences = _clean_sentence_list(sentence_list, language)
